...
function runCell(args){
  ...
  document.getElementById(savedData[0][y].ryg).setAttribute("checked", "True");
...
function creategrid(roomMin, roomMax) {
  ...
  data: [
    ...
    ["12", savedData[0].r11.patient, savedData[0].r11.provider, savedData[0].r11.rn, savedData[0].r11.status, savedData[0].r11.admit, savedData[0].r11.target, savedData[0].r11.los, savedData[0].r10.elos, savedData[0].r11.ryg, savedData[0].r11.dcby11, savedData[0].r11.dcplan, savedData[0].r11.barrier1, savedData[0].r11.barrier2, savedData[0].r11.readmissionrisk, savedData[0].r11.tele],
    ...
    ["14", savedData[0].r13.patient, savedData[0].r13.provider, savedData[0].r13.rn, savedData[0].r13.status, savedData[0].r13.admit, savedData[0].r13.target, savedData[0].r13.los, savedData[0].r10.elos, savedData[0].r13.ryg, savedData[0].r13.dcby11, savedData[0].r13.dcplan, savedData[0].r13.barrier1, savedData[0].r13.barrier2, savedData[0].r13.readmissionrisk, savedData[0].r13.tele],
    ...
    ["17", savedData[0].r16.patient, savedData[0].r16.provider, savedData[0].r10.rn, savedData[0].r16.status, savedData[0].r16.admit, savedData[0].r16.target, savedData[0].r16.los, savedData[0].r16.elos, savedData[0].r16.ryg, savedData[0].r16.dcby11, savedData[0].r16.dcplan, savedData[0].r16.barrier1, savedData[0].r16.barrier2, savedData[0].r16.readmissionrisk, savedData[0].r16.tele],
